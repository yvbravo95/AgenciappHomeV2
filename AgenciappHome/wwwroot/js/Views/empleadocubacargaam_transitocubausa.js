...
$(window).on("load", () => {
    ...
    tableIniciada = t.DataTable({
        ...
        ajax: {
            "url": `/empleadocubacargaam/GetData?status=Iniciadas`,
            "type": 'POST',
            "dataType": "json",
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, item) {
                    ...
                    html.push(`<a class="dropdown-item" href="/ordercubiq/detailbag?id=${data}"><i class="ft-info"></i>Detalles</a>`);
                    html.push('</div>');
                    html.push('</div>');
                    return html.join("");
                },
...
function LoadEvents() {
    ...
    $('#btn-nacionalizar').on('click', function () {
        ...
        swal({
            title: "¿Está seguro?",
            text: "¿Desea marcar como nacionalizadas las bolsas seleccionadas?",
            type: "warning",
