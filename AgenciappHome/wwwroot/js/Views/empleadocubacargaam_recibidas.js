...
$(window).on("load", () => {
    ...
    tableIniciada = t.DataTable({
        ...
        ajax: {
            "url": `/empleadocubacargaam/GetData?status=RecibidoAlmacen`,
            "type": 'POST',
            "dataType": "json",
...
function LoadEvents() {
    ...
    $(document).on("change", ".order-select", function () {
        ...
        if (cantSelect > 0) {
            $('#btn_distribuir').removeClass('hidden');
        }
        else {
    ...
    $('#btn_distribuir').on('click', function () {
        ...
        swal({
            title: "¿Está seguro?",
            text: "¿Desea marcar como distribuidas las órdenes seleccionadas?",
            type: "warning",
            ...
            if (isConfirm) {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            swal("¡Correcto!", "Las órdenes seleccionadas se han distribuido", "success");
                            ...
                            console.log(data);
                            swal("¡Error!", "Ha ocurrido un error al intentar distribuir los paquetes", "error");
                        }
                    },
                    error: function (data) {
                        console.log(data);
