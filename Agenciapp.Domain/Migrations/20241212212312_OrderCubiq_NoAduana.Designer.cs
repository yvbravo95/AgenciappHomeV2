...
namespace Agenciapp.Domain.Migrations
{
    ...
    [Migration("20241212212312_OrderCubiq_NoAduana")]
    partial class OrderCubiq_NoAduana
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.BagEM", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("DescriptionNotDelivered");

                    b.Property<Guid>("EnvioMaritimoId");

                    b.Property<string>("ImageDelivered");

                    b.Property<bool>("IsDelivered");

                    b.Property<bool>("IsNotDelivered");
                    ...
                    b.Property<string>("SignatureDelivered");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.CargaAMSeguro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CargaAMSeguros");
                });

            modelBuilder.Entity("Agenciapp.Domain.Models.CargaAMSeguroItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("CargaAMSeguroId");

                    b.Property<Guid>("CargaId");

                    b.HasKey("Id");

                    b.HasIndex("CargaAMSeguroId");

                    b.HasIndex("CargaId");

                    b.ToTable("CargaAMSeguroItems");
                });
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.DBViewModels.HMIncompleteOrdersReceived", b =>
                {
                    b.Property<string>("Number")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("HMIncompleteOrdersReceived");
                });
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.DBViewModels.OrdersDispatchedBaggageReceived", b =>
                {
                    ...
                    b.ToTable("OrdersDispatchedBaggageReceived");
                });
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.FlightCubaSearch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.Marketing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("PriceMms");

                    b.Property<string>("PriceSms");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.MarketingReceiptCampaing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("MarketingReceiptCampaings");
                });
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.MinoristaCarga", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.OrderContainer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ContactMunicipality");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.Pallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("PalletCubiq");
                });

            modelBuilder.Entity("Agenciapp.Domain.Models.PreDespachoCubiq", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("PreDespachoCubiqs");
                });

            modelBuilder.Entity("Agenciapp.Domain.Models.PreDespachoVerifiedItemCubiq", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("PaqueteNumber")
                        .IsRequired();

                    b.Property<Guid>("PreDespachoId");
                    ...
                    b.HasIndex("PreDespachoId");

                    b.ToTable("PreDespachoItemCubiqs");
                });

            modelBuilder.Entity("Agenciapp.Domain.Models.ProductCargaAm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.SettingRetailsStore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<decimal>("FeeRetail");

                    b.Property<decimal>("FeeWholesaler");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.SqlViews.ReporteLiquidacion", b =>
                {
                    ...
                    b.Property<decimal?>("Mercado_Amount");

                    b.Property<DateTime?>("Mercado_Date");

                    b.Property<string>("Mercado_Number");

                    b.Property<decimal?>("Mercado_Pagado");

                    b.Property<string>("Mercado_Status");
            ...
            modelBuilder.Entity("AgenciappHome.Models.CostoCarga", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("AgenciappHome.Models.OrderCubiq", b =>
                {
                    ...
                    b.Property<string>("CargoAdicionalDescription");
                    ...
                    b.Property<string>("EnaPassport");

                    b.Property<decimal>("InsuranceValue");

                    b.Property<bool>("IsAv");

                    b.Property<bool>("NoAduana");
                    ...
                    b.Property<bool>("RecogidaAlmacen");
            ...
            modelBuilder.Entity("AgenciappHome.Models.Paquete", b =>
                {
                    ...
                    b.Property<string>("AduanaDescription");

                    b.Property<Guid?>("AduanaId");

                    b.Property<decimal>("Aduanal");
            ...
            modelBuilder.Entity("AgenciappHome.Models.Passport", b =>
                {
                    ...
                    b.Property<DateTime>("FechaDespachoImportada");
                    ...
                    b.Property<string>("NumDespachoImportada");
            ...
            modelBuilder.Entity("AgenciappHome.Models.PreciosAutos", b =>
                {
                    ...
                    b.Property<decimal>("Minorista113");
                    ...
                    b.Property<decimal>("Minorista213");
            ...
            modelBuilder.Entity("AgenciappHome.Models.RegistroEstado", b =>
                {
                    ...
                    b.Property<Guid?>("OrderContainerId");
            ...
            modelBuilder.Entity("AgenciappHome.Models.User", b =>
                {
                    ...
                    b.Property<string>("WharehouseLocation");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.AttachmentOrder", b =>
                {
                    ...
                    b.ToTable("AttachmentOrder");

                    b.HasDiscriminator().HasValue("AttachmentOrder");
                });
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.AttachmentPassport", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .HasColumnName("AttachmentPassport_Description");
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.CargaAMSeguroItem", b =>
                {
                    b.HasOne("Agenciapp.Domain.Models.CargaAMSeguro", "CargaAMSeguro")
                        .WithMany()
                        .HasForeignKey("CargaAMSeguroId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AgenciappHome.Models.OrderCubiq", "Carga")
                        .WithMany("CargaAMSeguroItems")
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.HMpaquetesPriceByProvince", b =>
                {
                    ...
                    b.HasOne("AgenciappHome.Models.Minorista", "Retail")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.MarketingReceiptCampaing", b =>
                {
                    b.HasOne("Agenciapp.Domain.Models.Marketing", "Marketing")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.OrderContainer", b =>
                {
                    b.HasOne("AgenciappHome.Models.Minorista", "Afiliado")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.Pallet", b =>
                {
                    ...
                    b.HasOne("AgenciappHome.Models.GuiaAerea", "Guia")
                        .WithMany()
            ...
            modelBuilder.Entity("Agenciapp.Domain.Models.PreDespachoVerifiedItemCubiq", b =>
                {
                    ...
                    b.HasOne("AgenciappHome.Models.Paquete", "Paquete")
                        .WithMany()
                        .HasForeignKey("PaqueteId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Agenciapp.Domain.Models.PreDespachoCubiq", "PreDespacho")
                        .WithMany("Items")
                        .HasForeignKey("PreDespachoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("AgenciappHome.Models.Paquete", b =>
                {
                    b.HasOne("AgenciappHome.Models.Aduana", "Aduana")
                        .WithMany()
                    ...
                    b.HasOne("Agenciapp.Domain.Models.Pallet", "Pallet")
                        .WithMany("Packages")
            ...
            modelBuilder.Entity("AgenciappHome.Models.ProductosVendidos", b =>
                {
                    ...
                    b.HasOne("AgenciappHome.Models.Servicio")
                        .WithMany("Products")
                        .HasForeignKey("ServicioId");
                });
            ...
            modelBuilder.Entity("AgenciappHome.Models.RegistroEstado", b =>
                {
                    b.HasOne("Agenciapp.Domain.Models.BagEM", "BagEM")
                        .WithMany("RegistroEstados")
                        .HasForeignKey("BagEMId");
                    ...
                    b.HasOne("Agenciapp.Domain.Models.OrderContainer", "OrderContainer")
                        .WithMany("StateRegistry")
